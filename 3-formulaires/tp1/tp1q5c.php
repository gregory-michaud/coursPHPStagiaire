<?php
$choixImmo = filter_input(INPUT_GET, 'btnImmo', FILTER_SANITIZE_SPECIAL_CHARS);
if ($choixImmo) {
...
<html lang="fr">
    ...
    <body>
        ...
        afficheCode(['fichiers' => ['tp1q5c.php'], 'nomFichier' => true, 'correction' => true, 'commentaires' => 'Si le formulaire n\'a jamais été posté alors, il s\'affiche.<br>Les trois boutons de soumission du formulaire portent tous le même nom « btnImmo ». Si le formulaire a été posté, en fonction de la valeur associée à ce paramètre (donc en fonction du bouton cliqué), une redirection est effectuée vers la page portant ce nom.']);
        ?>
    </body>
</html>
