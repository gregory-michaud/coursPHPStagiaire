...
<html lang="fr">
    ...
    <body>
        ...
        <?php
        afficheCode(['fichiers' => ['VilleCtr.php', 'tp1q2.php'], 'nomFichier' => true, 'execution' => 'tp1q2.php', 'correction' => true, 'commentaires' => 'Le constructeur est une méthode magique nommé <code>__construct()</code>. Cette méthode magique est appelée automatiquement, si elle existe, lors de la création d\'une instance de cette classe. Ceci explique pourquoi il n\'est pas obligatoire.']);
        ?>
        ...
        <?php
        afficheCode(['fichiers' => ['Form.php', 'tp1q5.php'], 'nomFichier' => true, 'execution' => 'tp1q5.php', 'correction' => true, 'commentaires' => 'L\'attribut <code>formulaire</code> contient le code HTML nécessaire à l\'affichage du formulaire. Son contenu va être complété au fur et à mesure des appels aux méthodes de la classe.']);
        ?>
        ...
        <?php
        afficheCode(['fichiers' => ['Personne.php', 'Client.php', 'Electeur.php', 'tp1q7.php'], 'nomFichier' => true, 'execution' => 'tp1q7.php', 'correction' => true, 'commentaires' => 'La méthode magique <code>__toString()</code> est appelée automatiquement lorsque l\'instance est considérée comme une chaîne de caractères. C\'est par exemple le cas avec l\'instruction <code>echo $e1; par exemple</code>.']);
        ?>
    </body>
</html>
