...
<html lang="fr">
    ...
    <body>
        ...
        <?php
        afficheCode(['fichiers' => ['tp2q2.php'], 'execution' => 'tp2q2.php', 'correction' => true, 'commentaires' => 'Il aurait tout à fait possible été possible de faire quelque chose de similaire à la solution proposée pour la question précédente. Il aurait suffi d\'ajouter entre les crochets des six premières instructions les clés adéquates.<br>La solution proposée ici se base sur la création et l\'initialisation d\'un tableau en une seule instruction avec <a href="https://www.php.net/manual/fr/function.array.php"><code>array()</code></a> ou sa version plus courte <a href="https://www.php.net/manual/fr/language.types.array.php"><code>[]</code></a>.'])
        ?>
