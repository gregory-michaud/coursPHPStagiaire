...
$titrePage = 'Titre de la page ...'; // titre de la page
...
<html lang="fr">
    ...
    <body>
        ...
        ?>
        <h2>Affichage de valeur de variables pour débuger</h2>
        <?php
        $fichiers = ['varDump.php'];
        $execution = 'varDump.php';
        $commentaires = 'L\'affichage peut varier en fonction des extentions installées pour PHP. <a href="https://xdebug.org/">XDebug</a> permet par exemple d\'obtenir des informations plus facilement exploitables.';
        require '../../afficheCode2.php';
        ?>
        ...
        require '../../afficheCode2.php';
        ?>
        <h2 title="au-delà du programme">Assignation par référence</h2>
        <?php
        $fichiers = ['assRef.php'];
        ...
        require '../../afficheCode2.php';
        ?>
        <h2 title="au-delà du programme">Les variables dynamiques</h2>
        <?php
        $fichiers = ['varDyn.php'];
        ...
        $commentaires = "Le transtypage explicite est le seul à être encore d'actualité. Le transtypage implicite est maintenant déprécié et provoque un avertissement. Il ne faut plus l'utiliser.";
        require '../../afficheCode2.php';
        ?>
    </body>
</html>